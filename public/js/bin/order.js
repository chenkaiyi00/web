    ...
    .service('OrderFactory',['UserFactory','$http','baseURL',
      'localStorageService','$location',
        function(UserFactory,$http,baseURL,localStorageService,$location){
                 var self=this;
                  ...
                  this.startOrder = function(){
                    ...
                    if (!UserFactory.loggedIn()) {
                     ...
                     return $http.post(baseURL+'user/makeunsuborderNotLogin',
           ...
           **************************************************/
                ...
                // and making an order 
                this.updateUnsubAddNolog = function(address){
                    id=$location.search().id;
                    return $http.post(baseURL+'user/updateUnsubAddNolog',
                ...
                this.makeOrderUnlogin = function(unsuborder){
                               
                    return  $http.post(baseURL+"user/makeOrderUnlogin",
                  ...
                  this.getUnsuborderNotlogin = function(id){
      ...
      console.log('at getUnsuborder');
        ...
        console.log(response.data);
                  ...
                  // and edit add
                this.saveAddress = function(address,newadd,index){
                  ...
                  this.getTotal = function(){
                    var temp=0;
                         var cart = UserFactory.getCart();
                for (var i = 0; i <  cart.length; i++) {
                      if ( cart[i].check) {
                                temp+=cart[i].product.price*
                                  cart[i].quantity;
                      }
                }
                return temp;
